...
"
  ...
  case ${PLATFORM} in
    ...
    *)
      ...
      cat /proc/meminfo
      echo "cat /proc/meminfo | grep ^HugePages_Free"
      cat /proc/meminfo | grep ^HugePages_Free
      echo "cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g'"
      cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g'
      echo "cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g' | head -n 2"
      cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g' | head -n 2
      echo "cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g' | head -n 2 | tail -n 1"
      cat /proc/meminfo | grep ^HugePages_Free | sed 's/HugePages.*: *//g' | head -n 2 | tail -n 1
